...
HD_PWD='E:/Users/jxcai/FPGA_class/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log yi4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source yi4.tcl -notrace
