...
HD_PWD='E:/Users/jxcai/FPGA_class/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yi4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yi4.tcl
