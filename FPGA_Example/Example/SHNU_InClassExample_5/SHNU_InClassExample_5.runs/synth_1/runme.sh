...
HD_PWD='E:/Class/FPGA_class/Example/SHNU_InClassExample_5/SHNU_InClassExample_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MooreEdgeDetect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MooreEdgeDetect.tcl
