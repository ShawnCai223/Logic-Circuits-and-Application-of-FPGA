...
HD_PWD='D:/Users/20401/FPGAclass/inClassExample_1/inClassExample_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EvenParity.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EvenParity.tcl
