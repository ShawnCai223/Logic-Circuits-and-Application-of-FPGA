...
HD_PWD='D:/Users/20401/FPGAclass/inClassExample_1/inClassExample_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EvenParity.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EvenParity.tcl -notrace
