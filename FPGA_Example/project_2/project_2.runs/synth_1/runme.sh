...
HD_PWD='E:/Users/jxcai/FPGA_class/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log johnson2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source johnson2.tcl
