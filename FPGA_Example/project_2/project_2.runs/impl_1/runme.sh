...
HD_PWD='E:/Users/jxcai/FPGA_class/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log johnson2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source johnson2.tcl -notrace
