...
HD_PWD='E:/Class/FPGA_class/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rpcounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rpcounter.tcl
