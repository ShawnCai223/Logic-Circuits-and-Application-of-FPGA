...
HD_PWD='E:/Class/FPGA_class/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rpcounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rpcounter.tcl -notrace
